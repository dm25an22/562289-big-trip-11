...
export default class TripController {
  constructor(tripEventsContainer, tripInfoContainer, dayContainer, pointsModel) {
  ...
  _renderPoints() {
    ...
    this._pointControllers = renderEvents(this._tripInfoContainer, this._dayContainer, this._pointsModel.getPoints(), this._onDataChange, this._onViewChange);
  }
