...
class AbstractComponent {
  ...
  hideElement() {
    if (this._element) {
      this._element.classList.add(_consts__WEBPACK_IMPORTED_MODULE_1__["HIDDEN_CLASS"]);
    }
  }

  showElement() {
    if (this._element) {
      this._element.classList.remove(_consts__WEBPACK_IMPORTED_MODULE_1__["HIDDEN_CLASS"]);
    }
  }
...
class Statistic extends _abstract_smart_component__WEBPACK_IMPORTED_MODULE_2__["default"] {
  ...
  _getTransportData(typeData, points) {
    const transferTypes = typeData.filter((it) => {
      return _consts__WEBPACK_IMPORTED_MODULE_3__["TRIP_TRANSFERS"].some((type) => type === it);
    });
...
const getConvertTimeSpent = (minute) => {
  const hour = moment__WEBPACK_IMPORTED_MODULE_1___default.a.duration(minute, `minute`).asHours().toFixed(0);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _api___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./api  */ "./src/api .js");
